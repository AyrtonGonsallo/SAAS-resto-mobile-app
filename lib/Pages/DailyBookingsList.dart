...
import 'package:saas_resto_mobile_app/Models/Booking.dart';
import 'package:saas_resto_mobile_app/services/BookingService.dart';
...
class DailyBookingsListPage extends StatefulWidget {
  final int userId;


  const DailyBookingsListPage({super.key, required this.userId});

  @override
  State<DailyBookingsListPage> createState() => _DailyBookingsListPageState();
}

class _DailyBookingsListPageState extends State<DailyBookingsListPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Réservations du jour",style: const TextStyle(color: Colors.white),),
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              //  TITLE
               Text(
                "Liste des réservations du $today",
                style: TextStyle(
